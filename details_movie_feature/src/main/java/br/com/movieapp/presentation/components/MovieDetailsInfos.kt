...
fun MovieInfoContent(
    ...
    Row(
        ...
        MovieDetailsInfos(
            name = stringResource(id = br.com.movieapp.ui.R.string.vote_average),
            value = movieDetails?.voteAverage.toString()
        )
        MovieDetailsInfos(
            name = stringResource(id = br.com.movieapp.ui.R.string.duration),
            value = stringResource(
                id = br.com.movieapp.ui.R.string.duration_minutes,
                movieDetails?.duration.toString()
            )
        )
        MovieDetailsInfos(
            name = stringResource(id = br.com.movieapp.ui.R.string.release_date),
